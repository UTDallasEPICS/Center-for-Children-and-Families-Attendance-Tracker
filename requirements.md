...
| REQ-F-14  | Login page should allow users with a UTD account to login using UTD SSO for desktop.                                                                     | Backlog | 2026F           | [Issue #141](https://github.com/UTDallasEPICS/Center-for-Children-and-Families-Attendance-Tracker/issues/141)                               | -------------------------------------------- |
| REQ-F-15  | Login page should allow users with a UTD account to login using UTD SSO                                                                     | Backlog | 2026F           | —                               | -------------------------------------------- |
| REQ-F-16  | Admins can do everything a Site Manager can do across all sites.                                                                     | Backlog | 2026F           | —                               | -------------------------------------------- |
| REQ-F-17  | Admins can create, edit, and deactivate user accounts (interns, student workers, site managers, admins).                                                                   | Backlog | 2026F           | —                               | -------------------------------------------- |
| REQ-F-18  | Admins can assign roles and site placements for interns and student workers.                                                                  | Backlog | 2026F           | —                               | -------------------------------------------- |
