...
<template>
  ...
  <CalendarRoot
    ...
    data-slot="calendar"
    :class="cn('p-3 bg-popover text-popover-foreground', props.class)"
  >
    <slot name="header" :date="date" :grid="grid" :week-days="weekDays">
      <CalendarHeader class="pt-0 flex items-center justify-between gap-2">
        <CalendarPrevButton class="static translate-y-0 hover:bg-gray-100 rounded-md h-8 w-8 p-0 flex items-center justify-center">
        ...
        <CalendarNextButton class="static translate-y-0 hover:bg-gray-100 rounded-md h-8 w-8 p-0 flex items-center justify-center">
