<template>
  <div>
    ...
    <button @click="toggleMenu" class="menu-icon-button" :class="{ active: isOpen }" aria-label="Toggle menu">
      <span></span>
      <span></span>
      <span></span>
    </button>
    ...
    <div class="menu-panel" :class="{ open: isOpen }">
      ...
      <nav class="menu-nav">
        <NuxtLink to="/" @click="closeMenu" class="menu-item" :class="{ active: isActiveRoute('/') }">
          <span class="menu-item-text">Attendance Dashboard</span>
          <span v-if="isActiveRoute('/')" class="menu-item-indicator">●</span>
        </NuxtLink>

        <NuxtLink to="/participant" @click="closeMenu" class="menu-item" :class="{ active: isActiveRoute('/') }">
          <span class="menu-item-text">Participant Checkin</span>
          <span v-if="isActiveRoute('/')" class="menu-item-indicator">●</span>
        </NuxtLink>
      </nav>
    </div>
