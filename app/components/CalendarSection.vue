...
<template>
  <div class="bg-white w-[650px] min-h-[552px] p-5 m-5 rounded-xl flex flex-col items-center border-gray-200 border">
          
    <!-- Stats -->
    <div class="flex text-2xl justify-between w-full text-gray-600 mb-2">
      <span>Good</span>
    ...
    <div class="flex justify-between items-center w-full h-12 mb-2">
      <span class="text-gray-900 text-3xl"> {{ monthLabel }}</span>
