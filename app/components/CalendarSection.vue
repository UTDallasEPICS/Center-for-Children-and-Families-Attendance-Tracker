<template>
  <div class="bg-[#e5e5e5] px-4 py-[22px] rounded-[20px] mt-6">
    <div class="max-w-[420px] mx-auto">
      ...
      <p class="text-left text-[#666] text-[13px] mb-3">
        View your attendance, upcoming work days, and request absences.
      </p>

      <div class="bg-white rounded-[20px] p-[10px_4px] shadow-[0_2px_5px_rgba(0,0,0,0.08)]">
        <div 
          ref="calendarEl"
          class="min-h-[420px] overflow-visible"
        ></div>
      </div>
...
const upcomingWorkDays = ref<string[]>([
  '2025-10-22',
  '2025-10-23',
  '2025-10-24'
])
