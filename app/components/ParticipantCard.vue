...
<template>
  <div
    class="border border-[#28B357] rounded-[12px] bg-[rgba(108,194,138,0.29)] px-4 py-3 flex justify-between items-center"
    @click="handleClick"
  >
    ...
    <div class="space-y-1">
      ...
      <div class="flex items-center gap-2 text-[12px]">
        <span
          class="border-2 border-black w-[17px] h-[17px] flex items-center justify-center text-[10px]"
        >
          #
        </span>
    ...
    <div
      class="w-[75px] h-[55px] bg-[#D9D9D9] border border-[#48C596] rounded-[7px] flex items-center justify-center"
    >
      <span
