...
<template>
  <div class="min-h-screen bg-[#EFEFEF]">
    ...
    <main class="max-w-[394px] mx-auto px-2 pt-3 pb-24">
      ...
      <div class="mt-4 px-2">
        <div
          class="flex items-center gap-2 bg-[#E7E7E7] border border-[rgba(120,120,120,0.54)] rounded-[7px] px-3 h-[31px] w-full max-w-[380px] mx-auto"
        >
      ...
      <section
        class="mt-4 border border-[#9F9F9F] rounded-[12px] bg-[rgba(223,223,223,0.29)] px-4 pt-4 pb-6"
      >
        <!-- Participant header -->
        ...
        <div class="mt-3 space-y-2 text-[13px]">
          <div class="flex items-center gap-2">
            <div
              class="w-[17px] h-[17px] flex items-center justify-center border-2 border-black text-[10px]"
            >
              #
            </div>
            <span class="font-semibold text-black">
              ID: {{ currentParticipant?.recordId || '—' }}
            </span>
          </div>
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="font-medium text-black">
              Contact: {{ currentParticipant?.phone || '—' }}
            </span>
          </div>
        ...
        <!-- Guardian selection -->
        <section class="mt-5">
          <p class="text-[13px] font-medium text-black mb-2">
            please indicate guardian for today's session*:
          </p>

          <div class="grid grid-cols-2 gap-y-2 gap-x-4 text-[13px]">
            <label
              v-for="label in guardianOptions"
              :key="label"
              class="flex items-center gap-2"
            >
              <input
                type="checkbox"
                class="w-[13px] h-[13px] border border-black rounded-sm"
                :value="label"
        ...
        <section class="mt-5">
          <p class="text-[13px] font-medium text-black mb-1">
            information of other personnel:
          </p>
          <textarea
        ...
        <section class="mt-5">
          <p class="text-[13px] font-semibold text-black mb-2 leading-5">
            did the guardian bring an additional Child outside of the program*?:
          </p>
          ...
          <div class="space-y-1 text-[13px]">
            <label class="flex items-center gap-2">
              ...
              <input
                type="radio"
                name="extra-child"
                class="w-[17px] h-[17px] border border-black"
                value="yes"
                v-model="broughtExtraChild"
              />
            </label>
        ...
        <section class="mt-5">
          <p class="text-[13px] font-medium text-black mb-2 leading-5">
            if applicable, please indicate the name of external agency that
            joined today’s session.
          </p>
          <textarea
        ...
        <div class="mt-6 flex justify-center">
          <button
            type="button"
            class="w-[282px] h-[67px] bg-[#154734] rounded-[13px] flex items-center justify-center shadow-md"
            @click="submitForm"
          >
            <span
              class="text-white text-[16px] font-semibold leading-[22px] text-center drop-shadow-md"
            >
              Submit attendance
            </span>
          </button>
