<template>
  <div class="max-w-[480px] mx-auto px-4 py-5 mt-[calc(65px+env(safe-area-inset-top))]">
    <!-- WELCOME SECTION -->
    <section>
      <p class="text-center text-black font-bold mb-2.5">Welcome back! Mark your attendance and view your record.</p>

      <AttendanceCard ref="attendanceCardRef" @show-modal="showCheckoutModal = true" @show-pin-modal="showCheckInPinModal = true" />
  ...
  <CheckoutModal :show="showCheckoutModal" @confirm="handleCheckout" @cancel="showCheckoutModal = false" />

  <!-- CHECK IN PIN MODAL -->
  <CheckInPinModal :show="showCheckInPinModal" @confirm="handleCheckInPin" @cancel="showCheckInPinModal = false" />
</template>
